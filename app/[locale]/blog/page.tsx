    ...
    <main>
      <section className="bg-green-950 text-white">
        <div className="shell pt-32 pb-14 md:pt-40 md:pb-20">
          <p className="eyebrow eyebrow-light text-green-300">{b.hero.eyebrow}</p>
          <div className="mt-6 grid gap-7 lg:grid-cols-[1.3fr_0.7fr] lg:items-end lg:gap-20">
            <h1 className="text-[clamp(2.3rem,4.2vw,4rem)] leading-[1.1] tracking-[-0.035em]">{b.hero.title}</h1>
            <p className="max-w-md text-base leading-[1.8] text-white/70">{b.hero.lede}</p>
          </div>
        </div>
      </section>
      <section className="bg-paper py-12 md:py-16">
        <div className="shell">
          <Link href={`/${typed}/blog/${featured.slug}`} className="group grid overflow-hidden rounded-2xl bg-surface lg:grid-cols-[1.2fr_1fr]">
